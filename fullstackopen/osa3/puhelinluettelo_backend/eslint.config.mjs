...
//Muodostetaan alustava ESLint-konfiguraatio ja vastataan kysymyksiin
// npx eslint --init
// Asennetaan seuraavaksi liitännäinen @stylistic/eslint-plugin jonka avulla saamme käyttöömme joukon valmiiksi määriteltyjä ESlint-säntöjä:
// npm install --save-dev @stylistic/eslint-plugin
// aja tarkistus = npx eslint .
//korjaa virheet = npx eslint . --fix
